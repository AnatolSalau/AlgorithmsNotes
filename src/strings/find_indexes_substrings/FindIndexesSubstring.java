 ...
 * Output: 0, 10, 13, 16
 */
public class FindIndexesSubstring {
      public static void main(String[] args) {
            FindIndexesSubstring findIndexesSubstring = new FindIndexesSubstring();
            findIndexesSubstring.test1();
            findIndexesSubstring.test2();
            findIndexesSubstring.test3();
      }
