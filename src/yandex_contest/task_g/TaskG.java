...
public class TaskG {
       ...
       * 2. Обходим граф в ширину начиная с заданного для старта города
       *          используем очередь городов и сэт с уже посещенными городами - где отмечаем посещенные
       *          во время обхода кладем в очередь необходимых для посещения городов - только города
       *          которые находятся на допустимом расстоянии от текущего города
       * 3. Результат алгоритма - это количество посещенных городов
       */
